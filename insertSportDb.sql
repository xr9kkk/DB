...
((SELECT athlete_id FROM Athlete WHERE last_name = 'Kozlov'), '2022-06-10', (SELECT rank_title_id FROM Rank_title WHERE rank_title = 'First Category')),
((SELECT athlete_id FROM Athlete WHERE last_name = 'Kozlov'), '2023-11-20', (SELECT rank_title_id FROM Rank_title WHERE rank_title = 'Candidate Master')),
((SELECT athlete_id FROM Athlete WHERE last_name = 'Moroz'), '2021-12-05', (SELECT rank_title_id FROM Rank_title WHERE rank_title = 'First Category'));

-- Award
INSERT INTO Award (athlete_id, award_date, award_type_id) VALUES 
((SELECT athlete_id FROM Athlete WHERE last_name = 'Kozlov'), '2023-05-15', (SELECT award_type_id FROM Award_type WHERE award_name = 'Gold Medal')),
((SELECT athlete_id FROM Athlete WHERE last_name = 'Moroz'), '2023-05-15', (SELECT award_type_id FROM Award_type WHERE award_name = 'Silver Medal'));
...
-- ((SELECT match_id FROM Match WHERE result_1 = 2), 'Moscow Championship', '2024-03-10 10:00:00', '2024-03-15 22:00:00', 'Luzhniki Stadium', 1000000.00, 'Moscow, Luzhniki st. 24'),
-- ((SELECT match_id FROM Match WHERE result_1 = 3), 'International Cup', '2024-03-12 09:00:00', '2024-03-20 21:00:00', 'Staples Center', 2000000.00, 'Los Angeles, Figueroa Street');
...
-- INSERT INTO Tournament (match_id, name, start_date, end_date, venue_name, prize_fund, venue_address) VALUES 
-- ((SELECT match_id FROM Match LIMIT 1), 'Test Tournament NULL', '2024-03-10 10:00:00', '2024-03-15 22:00:00', 'Test Stadium', 100000.00, NULL),
-- ((SELECT match_id FROM Match LIMIT 1 OFFSET 1), 'Test Tournament Empty', '2024-03-12 09:00:00', '2024-03-20 21:00:00', 'Test Arena', 200000.00, '');
...
INSERT INTO City (name, region_id) VALUES 
('Paris', (SELECT region_id FROM Region WHERE name = 'Île-de-France')),
...
((SELECT athlete_id FROM Athlete WHERE last_name = 'Schneider'), '2020-12-10', (SELECT rank_title_id FROM Rank_title WHERE rank_title = 'Master of Sports')),
...
-- Сначала добавим больше турниров на одни и те же стадионы
INSERT INTO Tournament (match_id, name, start_date, end_date, venue_name, prize_fund, venue_address) VALUES
-- Добавим еще турниры на стадион 'Olympic Stadium'
...
SELECT DISTINCT
    r.athlete_id,
    DATE(r.assignment_date - INTERVAL '1 year'),
    rt4.rank_title_id
FROM Rank r
JOIN Athlete a ON r.athlete_id = a.athlete_id
JOIN Rank_title rt1 ON r.rank_title_id = rt1.rank_title_id
LEFT JOIN Rank_title rt2 ON rt1.previous_rank_id = rt2.rank_title_id
LEFT JOIN Rank_title rt3 ON rt2.previous_rank_id = rt3.rank_title_id
LEFT JOIN Rank_title rt4 ON rt3.previous_rank_id = rt4.rank_title_id
LEFT JOIN Rank_title rt5 ON rt4.previous_rank_id = rt5.rank_title_id
CROSS JOIN LATERAL (
    VALUES 
        (rt2.rank_title_id, DATE(r.assignment_date - INTERVAL '1 year')),
        (rt3.rank_title_id, DATE(r.assignment_date - INTERVAL '2 years')),
        (rt4.rank_title_id, DATE(r.assignment_date - INTERVAL '3 years')),
        (rt5.rank_title_id, DATE(r.assignment_date - INTERVAL '4 years'))
) AS missing_ranks(rank_id_to_add, assign_date)
WHERE a.gender = 'female'
  AND missing_ranks.rank_id_to_add IS NOT NULL
  AND NOT EXISTS (
    SELECT 1 
    FROM Rank r2 
    WHERE r2.athlete_id = r.athlete_id 
      AND r2.rank_title_id = missing_ranks.rank_id_to_add
  );
...
((SELECT club_id FROM Club WHERE name = 'Tokyo Giants'), 'Yamamoto', 'Kenji', NULL, 'male', '2000-11-30', '+81398765003', 178.5, 70.8, (SELECT game_position_id FROM GamePosition WHERE position_name = 'Полузащитник')),
((SELECT club_id FROM Club WHERE name = 'Bayern'), 'Yamamoto', 'Sakura', NULL, 'female', '2003-05-14', '+49891234004', 165.2, 56.7, (SELECT game_position_id FROM GamePosition WHERE position_name = 'Защитник')),

((SELECT club_id FROM Club WHERE name = 'Dynamo'), 'Sokolov', 'Alexander', 'Ivanovich', 'male', '1999-09-08', '+79163334005', 190.1, 84.3, (SELECT game_position_id FROM GamePosition WHERE position_name = 'Вратарь')),
((SELECT club_id FROM Club WHERE name = 'Ural'), 'Sokolova', 'Natalia', 'Petrovna', 'female', '2004-02-19', '+79165556006', 172.8, 63.4, (SELECT game_position_id FROM GamePosition WHERE position_name = 'Нападающий')),


INSERT INTO sponsor_person (sponsor_id, last_name, first_name, middle_name) 
SELECT 
    s.sponsor_id,
    'Ivanov' as last_name,
    'Pavel' as first_name,
    'Nikolaevich' as middle_name
FROM Sponsor s 
WHERE s.contact_phone = '+79161112299'
UNION ALL
SELECT 
    s.sponsor_id,
    'Kozlov',
    ...
    'Vladimirovich'
FROM Sponsor s 
WHERE s.contact_phone = '+79162223300'
UNION ALL
SELECT 
    s.sponsor_id,
    'Smirnov',
    ...
    'Ivanovich'
FROM Sponsor s 
WHERE s.contact_phone = '+79163334411'
UNION ALL
SELECT 
    s.sponsor_id,
    'Volkov',
    ...
    'Petrovich'
FROM Sponsor s 
WHERE s.contact_phone = '+79164445522';

INSERT INTO Athlete (club_id, last_name, first_name, middle_name, gender, birth_date, phone, height, weight, game_position_id) VALUES 
((SELECT club_id FROM Club WHERE name = 'London Royals'), 'Wilson', 'David', NULL, 'male', '2001-04-10', '+44770012007', 183.7, 79.1, (SELECT game_position_id FROM GamePosition WHERE position_name = 'Защитник')),
((SELECT club_id FROM Club WHERE name = 'PSG'), 'Martin', 'Luc', NULL, 'male', '2002-08-25', '+33123456008', 179.2, 74.8, (SELECT game_position_id FROM GamePosition WHERE position_name = 'Полузащитник')),
((SELECT club_id FROM Club WHERE name = 'São Paulo FC'), 'Silva', 'Ricardo', 'Fernando', 'male', '2000-12-03', '+55119988009', 186.4, 81.5, (SELECT game_position_id FROM GamePosition WHERE position_name = 'Нападающий')),
((SELECT club_id FROM Club WHERE name = 'Houston Rockets'), 'Brown', 'Matthew', NULL, 'male', '2003-06-18', '+17135552010', 191.0, 87.2, (SELECT game_position_id FROM GamePosition WHERE position_name = 'Центральный нападающий'));
...
SELECT 
    ...
    NULL as middle_name
FROM Sponsor s 
WHERE s.contact_phone = '+44201112233'
UNION ALL
SELECT 
    s.sponsor_id,
    'Martin',
    ...
    'Jacques'
FROM Sponsor s 
WHERE s.contact_phone = '+33198765499'
UNION ALL
SELECT 
    s.sponsor_id,
    'Silva',
    ...
    'Carlos'
FROM Sponsor s 
WHERE s.contact_phone = '+55119887766'
UNION ALL
SELECT 
    s.sponsor_id,
    'Brown',
    ...
    'William'
FROM Sponsor s 
WHERE s.contact_phone = '+13105559900';



INSERT INTO Athlete (club_id, last_name, first_name, middle_name, gender, birth_date, phone, height, weight, game_position_id) VALUES 
((SELECT club_id FROM Club WHERE name = 'Spartak'), 'Fedorov', 'Alexander', 'Viktorovich', 'male', '1998-05-20', '+79161111111', 185.5, 78.2, (SELECT game_position_id FROM GamePosition WHERE position_name = 'Нападающий')),
((SELECT club_id FROM Club WHERE name = 'Spartak'), 'Ivanova', 'Maria', 'Sergeevna', 'female', '2000-08-15', '+79162222222', 172.3, 60.5, (SELECT game_position_id FROM GamePosition WHERE position_name = 'Защитник')),
((SELECT club_id FROM Club WHERE name = 'Spartak'), 'Sokolov', 'Pavel', 'Dmitrievich', 'male', '1999-03-10', '+79163333333', 188.0, 82.1, (SELECT game_position_id FROM GamePosition WHERE position_name = 'Вратарь')),
((SELECT club_id FROM Club WHERE name = 'Spartak'), 'Nikolaeva', 'Ekaterina', 'Andreevna', 'female', '2001-11-25', '+79164444444', 168.7, 58.3, (SELECT game_position_id FROM GamePosition WHERE position_name = 'Полузащитник')),
((SELECT club_id FROM Club WHERE name = 'Spartak'), 'Orlov', 'Dmitry', 'Ivanovich', 'male', '1997-07-08', '+79165555555', 182.4, 76.8, (SELECT game_position_id FROM GamePosition WHERE position_name = 'Крайний защитник'));
...
((SELECT athlete_id FROM Athlete WHERE last_name = 'Sokolov' AND first_name = 'Pavel'), '2023-09-12', (SELECT award_type_id FROM Award_type WHERE award_name = 'Best Goalkeeper')); -- Еще один Best Goalkeeper
...
SELECT 
    athlete_id,
    '2022-06-10',
    (SELECT award_type_id FROM Award_type WHERE award_name = 'Gold Medal')
FROM Athlete 
WHERE last_name = 'Kozlov' AND first_name = 'Ivan'
AND club_id = (SELECT club_id FROM Club WHERE name = 'Spartak');

INSERT INTO Award (athlete_id, award_date, award_type_id) 
SELECT 
    athlete_id,
    '2022-12-05',
    (SELECT award_type_id FROM Award_type WHERE award_name = 'Silver Medal')
FROM Athlete 
WHERE last_name = 'Moroz' AND first_name = 'Anna'
AND club_id = (SELECT club_id FROM Club WHERE name = 'Spartak');

INSERT INTO Athlete (club_id, last_name, first_name, middle_name, gender, birth_date, phone, height, weight, game_position_id) VALUES 
((SELECT club_id FROM Club WHERE name = 'Spartak'), 'Voronov', 'Sergey', 'Petrovich', 'male', '2000-02-14', '+79166666666', 184.2, 79.5, (SELECT game_position_id FROM GamePosition WHERE position_name = 'Нападающий'));
